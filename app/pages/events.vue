<template>
  <div>
    <h2 class="text-2xl font-display font-semibold mb-6 text-skyBlue">Upcoming Events</h2>
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="event in events" :key="event._id" class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
        <h3 class="text-xl font-display font-bold text-royalBlue mb-2">{{ event.title }}</h3>
